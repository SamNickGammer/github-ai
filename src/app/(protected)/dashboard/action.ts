    ...
    (async () => {
        const {textStream} = await streamText({
            ...
            prompt: `
                ...
                AI has the sum of all knowledge in its brain, and is able to accurately answer nearly any question about any topic in detail.
                ...
                If the context does not provide the answer to the question, the AI assistant will say, "I'm sorry, but I don't know the answer," but instead will indicate new information was gained.
                AI assistant will not apologize for previous responses.
